...
#import "XXDropDownMenu.h"

@implementation XXIndexPath
...
+ (instancetype)indexPathWithCol:(NSInteger)col row:(NSInteger)row {
    XXIndexPath *indexPath = [[self alloc] initWithColumn:col row:row];
    return indexPath;
}
@end
...
#pragma mark - setter
- (void)setDataSource:(id<XXDropDownMenuDataSource>)dataSource {
...
//    CGFloat separatorLineInterval = self.frame.size.width / _numOfMenu;
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        ...
        NSString *titleString = [_dataSource menu:self titleForRowAtIndexPath:[XXIndexPath indexPathWithCol:i row:0]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.dataSource respondsToSelector:@selector(menu:titleForRowAtIndexPath:)]) {
        cell.textLabel.text = [self.dataSource menu:self titleForRowAtIndexPath:[XXIndexPath indexPathWithCol:self.currentSelectedMenudIndex row:indexPath.row]];
    } else {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (self.delegate || [self.delegate respondsToSelector:@selector(menu:didSelectRowAtIndexPath:)]) {
        ...
        [self.delegate menu:self didSelectRowAtIndexPath:[XXIndexPath indexPathWithCol:self.currentSelectedMenudIndex row:indexPath.row]];
    } else {
...
- (void)confiMenuWithSelectRow:(NSInteger)row {
    ...
    title.string = [self.dataSource menu:self titleForRowAtIndexPath:[XXIndexPath indexPathWithCol:self.currentSelectedMenudIndex row:row]];
